...
class Item(models.Model):
    ...
    favorite_level = models.IntegerField(verbose_name = 'お気に入り度', choices = FAVORITE_LEVEL_CHOICES, blank=True,null=True)
    item_importance = models.IntegerField(verbose_name = '大事さ', choices = ITEM_IMPORTANCE_CHOICES,blank=True,null=True)
    create_date = models.DateTimeField(verbose_name = '作成日', auto_now_add=True)
